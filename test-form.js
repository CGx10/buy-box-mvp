// Test script to submit form data and debug the analysis
const testData = {
    userData: {
        // Module A - Competency ratings and evidence
        sales_marketing: {
            rating: 5,
        ...
        // Module C - Financial and lifestyle
        total_liquid_capital: 50000,
        potential_loan_amount: 500000,
        min_annual_income: 100000,
        time_commitment: 60,
        location_preference: "Willing to relocate",
        location_regions: "Denver CO, San Diego CA, San Francisco CA, Miami FL",
        risk_tolerance: "high"
    },
    engines: ["traditional", "gemini"]
};

async function testComparison() {
    console.log('Testing comparison analysis with provided data...');
    ...
    try {
        ...
        if (result.success) {
            ...
            console.log('Results data keys:', Object.keys(result.data));
            if (result.data.results) {
                console.log('Engine results:', Object.keys(result.data.results));
            }
            if (result.data.comparison) {
                console.log('Comparison data keys:', Object.keys(result.data.comparison));
            }
        } else {
